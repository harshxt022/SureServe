  ...
  return (
    <>
      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${scrolled ? 'bg-[#FAFAF8]/90 backdrop-blur-md shadow-[0_1px_0_#E8E8E4]' : 'bg-transparent'}`}>
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:flex items-center gap-8">
              <a href="#services" className="text-sm font-medium text-[#6B6B6B] hover:text-[#1A1A1A] transition-colors">Services</a>
              <a href="#how-it-works" className="text-sm font-medium text-[#6B6B6B] hover:text-[#1A1A1A] transition-colors">How It Works</a>
              ...
              {isAuthenticated ? (
                <>
                  ...
                  <div className="relative group ml-2">
                      <div className="w-8 h-8 rounded-full bg-[#E8E8E4] flex items-center justify-center text-[#1A1A1A] text-sm font-bold shadow-sm cursor-pointer hover:bg-[#D6D6D6] transition-colors">
        ...
        {isMobileMenuOpen && (
            <div className="md:hidden bg-white border-b border-[#E8E8E4] px-6 py-4 space-y-4 shadow-lg absolute w-full left-0 animate-slideDown">
                <a href="#services" onClick={() => setIsMobileMenuOpen(false)} className="block text-base font-medium text-[#1A1A1A]">Services</a>
                <a href="#how-it-works" onClick={() => setIsMobileMenuOpen(false)} className="block text-base font-medium text-[#1A1A1A]">How It Works</a>
                
                {isAuthenticated ? (
                    <>
                        <Link to="/dashboard" className="block text-base font-medium text-[#1A1A1A]">Dashboard</Link>
                        <Link to="/profile" className="block text-base font-medium text-[#1A1A1A]">Profile</Link>
                        <button onClick={handleLogout} className="block w-full text-left text-base font-medium text-red-500">Logout</button>
                    </>
                ) : (
                    <div className="pt-2 flex flex-col gap-3">
                        <Link to="/login" className="block w-full text-center bg-gray-100 text-[#1A1A1A] py-3 rounded-xl font-semibold">Login</Link>
                        <Link to="/register-user" className="block w-full text-center bg-[#4F46E5] text-white py-3 rounded-xl font-semibold">Get Started</Link>
                    </div>
                )}
            </div>
        )}
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 reveal">
            ...
            <a href="/category/electrical"
              className="card-accent hover-lift col-span-2 row-span-2 rounded-3xl p-8 border border-[#E8E8E4] cursor-pointer group transition-shadow hover:shadow-[0_16px_48px_rgba(0,0,0,0.06)] relative overflow-hidden flex flex-col justify-end min-h-[300px]"
            >
              <div className="absolute inset-0 bg-cover bg-center transition-transform duration-700 group-hover:scale-105" style={{ backgroundImage: `url(${IMAGES.electrical})` }}></div>
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent"></div>

              <div className="relative z-10">
                <span className="w-12 h-12 rounded-xl bg-white/20 backdrop-blur-md flex items-center justify-center text-2xl mb-4 text-white shadow-sm border border-white/10">⚡</span>
                <h3 className="text-3xl font-bold font-heading text-white mb-2">Electrical</h3>
                <p className="text-gray-200 text-sm mb-4 max-w-sm">Wiring, switches, fans, solar panels and more.</p>
                <span className="text-white text-sm font-semibold flex items-center gap-2 group-hover:text-[#4F46E5] transition-colors bg-white/10 hover:bg-white backdrop-blur-md px-4 py-2 rounded-full w-max">
            ...
            <a href="/category/plumbing"
              className="card-accent hover-lift rounded-3xl p-6 border border-[#E8E8E4] cursor-pointer group transition-shadow hover:shadow-[0_16px_48px_rgba(0,0,0,0.06)] relative overflow-hidden min-h-[180px] flex flex-col justify-end"
            >
              <div className="absolute inset-0 bg-cover bg-center transition-transform duration-700 group-hover:scale-105" style={{ backgroundImage: `url(${IMAGES.plumbing})` }}></div>
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent"></div>

              <div className="relative z-10 flex items-center justify-between mt-auto">
                <div>
                  <span className="text-2xl block mb-2 opacity-90">🔧</span>
                  <h3 className="text-lg font-bold font-heading text-white">Plumbing</h3>
                </div>
                <div className="w-8 h-8 rounded-full bg-white/20 backdrop-blur-md flex items-center justify-center text-white border border-white/10 opacity-0 group-hover:opacity-100 transition-all duration-300 translate-x-2 group-hover:translate-x-0">
                  <i className="fas fa-arrow-right text-xs"></i>
                </div>
              </div>
            </a>

            <a href="/category/ac-services"
              className="card-accent hover-lift rounded-3xl p-6 border border-[#E8E8E4] cursor-pointer group transition-shadow hover:shadow-[0_16px_48px_rgba(0,0,0,0.06)] relative overflow-hidden min-h-[180px] flex flex-col justify-end"
            >
              <div className="absolute inset-0 bg-cover bg-center transition-transform duration-700 group-hover:scale-105" style={{ backgroundImage: `url(${IMAGES.ac})` }}></div>
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent"></div>

              <div className="relative z-10 flex items-center justify-between mt-auto">
                <div>
                  <span className="text-2xl block mb-2 opacity-90">❄️</span>
                  <h3 className="text-lg font-bold font-heading text-white">AC Services</h3>
                </div>
                <div className="w-8 h-8 rounded-full bg-white/20 backdrop-blur-md flex items-center justify-center text-white border border-white/10 opacity-0 group-hover:opacity-100 transition-all duration-300 translate-x-2 group-hover:translate-x-0">
                  <i className="fas fa-arrow-right text-xs"></i>
                </div>
            ...
            <a href="/category/cleaning"
              className="card-accent hover-lift rounded-3xl p-6 border border-[#E8E8E4] cursor-pointer group transition-shadow hover:shadow-[0_16px_48px_rgba(0,0,0,0.06)] relative overflow-hidden min-h-[180px] flex flex-col justify-end"
            >
              <div className="absolute inset-0 bg-cover bg-center transition-transform duration-700 group-hover:scale-105" style={{ backgroundImage: `url(${IMAGES.cleaning})` }}></div>
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent"></div>

              <div className="relative z-10 flex items-center justify-between mt-auto">
                <div>
                  <span className="text-2xl block mb-2 opacity-90">🧹</span>
                  <h3 className="text-lg font-bold font-heading text-white">Cleaning</h3>
                </div>
                <div className="w-8 h-8 rounded-full bg-white/20 backdrop-blur-md flex items-center justify-center text-white border border-white/10 opacity-0 group-hover:opacity-100 transition-all duration-300 translate-x-2 group-hover:translate-x-0">
                  <i className="fas fa-arrow-right text-xs"></i>
                </div>
            ...
            <a href="/category/carpentry"
              className="card-accent hover-lift rounded-3xl p-6 border border-[#E8E8E4] cursor-pointer group transition-shadow hover:shadow-[0_16px_48px_rgba(0,0,0,0.06)] relative overflow-hidden min-h-[180px] flex flex-col justify-end"
            >
              <div className="absolute inset-0 bg-cover bg-center transition-transform duration-700 group-hover:scale-105" style={{ backgroundImage: `url(${IMAGES.carpentry})` }}></div>
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent"></div>

              <div className="relative z-10 flex items-center justify-between mt-auto">
                <div>
                  <span className="text-2xl block mb-2 opacity-90">🔨</span>
                  <h3 className="text-lg font-bold font-heading text-white">Carpentry</h3>
                </div>
                <div className="w-8 h-8 rounded-full bg-white/20 backdrop-blur-md flex items-center justify-center text-white border border-white/10 opacity-0 group-hover:opacity-100 transition-all duration-300 translate-x-2 group-hover:translate-x-0">
                  <i className="fas fa-arrow-right text-xs"></i>
                </div>
            ...
            <a href="/category/appliances"
              className="card-accent hover-lift col-span-2 rounded-3xl p-6 border border-[#E8E8E4] cursor-pointer group flex items-center gap-6 transition-shadow hover:shadow-[0_16px_48px_rgba(0,0,0,0.06)] relative overflow-hidden"
            >
              <div className="absolute inset-0 bg-cover bg-center transition-transform duration-700 group-hover:scale-105" style={{ backgroundImage: `url(${IMAGES.appliances})` }}></div>
              <div className="absolute inset-0 bg-gradient-to-r from-black/80 via-black/60 to-transparent"></div>

              <div className="relative z-10 flex items-center w-full">
                <div className="w-14 h-14 rounded-2xl bg-white/20 backdrop-blur-md flex items-center justify-center text-3xl text-white mr-6 border border-white/10 shadow-sm shrink-0">📺</div>
                <div>
                  <h3 className="text-xl font-bold font-heading text-white mb-1">Appliance Repair</h3>
                  <p className="text-gray-200 text-sm">Refrigerators, washing machines, microwaves & more</p>
                </div>
                <div className="w-10 h-10 rounded-full bg-white/20 backdrop-blur-md flex items-center justify-center text-white border border-white/10 opacity-0 group-hover:opacity-100 transition-all duration-300 ml-auto translate-x-4 group-hover:translate-x-0 shadow-sm">
              ...
              <div className="hover-lift bg-white rounded-3xl p-6 border border-[#E8E8E4] sm:mt-12 transition-shadow hover:shadow-[0_16px_48px_rgba(0,0,0,0.06)]">
                <div className="flex justify-between items-start mb-5">
                  <img 
                    ...
                    onError={(e) => {
                      e.target.src = `https://ui-avatars.com/api/?name=Ramesh+Sharma&background=random`;
                    }}
                  />
              ...
              <div className="hover-lift bg-white rounded-3xl p-6 border border-[#E8E8E4] transition-shadow hover:shadow-[0_16px_48px_rgba(0,0,0,0.06)]">
                <div className="flex justify-between items-start mb-5">
                  <img 
                    ...
                    className="w-14 h-14 rounded-2xl object-cover" 
                    onError={(e) => {
                      e.target.src = `https://ui-avatars.com/api/?name=Amit+Verma&background=random`;
                    }}
                  />
                  <div className="bg-[#FAFAF8] text-[#1A1A1A] px-3 py-1 rounded-full text-sm font-bold flex items-center gap-1 border border-[#E8E8E4]">
